...
function findEmployeeBySpec(employeeSpec){
    ...
    console.log(specEmployee);
        ...
        document.getElementById('employeesDetails').innerHTML = `<p>${specEmployee.id}: ${specEmployee.name} - ${specEmployee.department} - $${specEmployee.salary} - ${specEmployee.specialization}</p>`;
    }
    else{
